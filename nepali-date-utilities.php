...
function ndu_nepali_date_utilities_page()
{
    ...
    <div class="wrap">
        <form method="POST">
            ...
            <input type="checkbox" name="ndu_convert_post_date" <?php echo ($convertPostDate == "1") ? 'checked' : ''; ?>
                style="margin-top: 0px;" /> <br /><br />
            <label for="ndu_date_format">Post Date Format( y m d l H/h i s a) </label>
            <input type="text" name="ndu_date_format" class="large-text" value="<?php echo $dateformat; ?>"
                placeholder="Format" /><br /><br />
            ...
            <input type="text" name="ndu_today_date_format" class="large-text" value="<?php echo $todayDateformat; ?>"
    ...
    <ol>
        ...
        <li>
            <code><?php echo htmlspecialchars("<?php echo do_shortcode('[ndu_today_date]');?>"); ?></code> to print today's
